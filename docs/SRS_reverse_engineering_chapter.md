...
* **50 BVA Test Cases** cover input time bounds, pagination size constraints, age and phone formatting limits, diagnostic ranges for vital signs, and text fields limits.
* **36 EP Test Cases** cover RFC-compliant email formats, password complexity levels, account statuses, entity IDs, appointment form completeness, and automated classification rules.
